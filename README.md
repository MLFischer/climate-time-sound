...
Four modes — **learn · studio · classic · paleo** — one shared engine, a
light/dark toggle, and a data→sound link you can point at.
...
| **paleo** | Deep time, 18 real records (LR04, EPICA CO₂/temperature, Vostok, NGRIP, Saharan dust ODP 967, Lake Ohrid, Milankovitch cycles, African lake records …) with a **sound-approach switch**: *layered* (all proxies as stacked voices — the multitrack lab), *electronic* (the lead proxy through the studio engine), or *classical* (as chamber music). One-click constellations, span, tempo, a **"today" CO₂ marker**, deep-time listening tasks; key/scale, per-track level and **lead–lag time-shift** tucked under "advanced". | Tiefenzeit, 18 echte Reihen (LR04, EPICA-CO₂/Temperatur, Vostok, NGRIP, Sahara-Staub ODP 967, Ohridsee, Milankovitch-Zyklen, afrikanische Seesedimente …) mit **Klangart-Umschalter**: *struktur* (alle Proxys als übereinandergelegte Stimmen — das Mehrspur-Lab), *elektro* (die Leitreihe durch die Studio-Engine) oder *klassik* (als Kammermusik). Ein-Klick-Konstellationen, Zeitspanne, Tempo, ein **„Heute"-CO₂-Marker**, Höraufgaben; Tonart/Skala, Pegel und **Lead–Lag-Versatz** unter „Feinabstimmung". |
